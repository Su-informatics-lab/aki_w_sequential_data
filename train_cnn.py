...
def main(args):
    ...
    # Create run name for wandb and checkpoint folder (for CNN, include CNN in the project name)
    ...
    # Initialize wandb with a project name specific for CNN experiments
    wandb.init(project=f"{args.disease.upper()}_CNN", name=run_name, config=vars(args))
    ...
    # Use a CNN-specific checkpoints directory
